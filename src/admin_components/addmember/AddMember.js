          ...
          <div className="form-box-r">
            ...
            <div className="loginplans">
              ...
              >
                ...
                <option value="proSilver"> Pro Silver</option>
                <option value="proGold">Pro Gold</option>
                <option value="proPlatinum">Pro Platinum</option>
                <option value="proDiamond">Pro Diamond</option>
              </select>
            </div>
